                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('categories.update', $category->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $category->name }}" aria-describedby="nameHelp" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ $category->description }}" aria-describedby="descHelp">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10 offset-2">
                                ...
                                <a href="{{ route('categories.index') }}" class="btn btn-secondary">{{ __('Quay lại') }}</a>
                            </div>
                        </div>
                    </form>
                </div><!-- .card-body -->
